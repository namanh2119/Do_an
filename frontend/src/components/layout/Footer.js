            ...
            <div className="row">
              <div className="col-lg-5 col-md-6 col-12">
                ...
                <div className="single-footer about">
                  <div className="logo">
                    <a href="index.html"><img style={{width: '90px', height: '90px'}} src="/images/logo.png" alt="#" /></a>
                  </div>
                  <p className="text">Website bán hàng Thế giới ăn vặt, hỗ trợ 24/7 cùng nhiều ưu đẫi hấp dẫn. Luôn luôn cập nhật mới nhiều sản phẩm.</p>
              ...
              <div className="col-lg-3 col-md-6 col-12">
                ...
                <div className="single-footer social">
                  ...
                  <div className="contact">
                    <ul className='lists-footer'>
                      <li>Số 263 Ngô Gia Tự, Long Biên, Hà Nội</li>
                      <li>Hoàng Nam</li>
                      <li>namshop22113@gmail.com</li>
                      <li>+012 3456 7890</li>
                    </ul>
                  </div>
                  {/* End Single Widget */}
